...
import cs.vsu.repository.ImageRepository;
...
/**
 * REST controller for managing {@link cs.vsu.domain.Image}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ImageResource {
     ...
     */
    @GetMapping("/images")
    public List<Image> getAllImages(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get all Images");
        return imageRepository.findAllWithEagerRelationships();
    }
