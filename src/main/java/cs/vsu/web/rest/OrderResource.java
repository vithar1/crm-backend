...
/**
 * REST controller for managing {@link cs.vsu.domain.Order}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Order> result = orderRepository
            ...
            .map(existingOrder -> {
                if (order.getAcceptTime() != null) {
                    existingOrder.setAcceptTime(order.getAcceptTime());
                }
                if (order.getCompleteTime() != null) {
                    existingOrder.setCompleteTime(order.getCompleteTime());
                }
