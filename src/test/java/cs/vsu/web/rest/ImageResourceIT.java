...
class ImageResourceIT {
    ...
    public static Image createEntity(EntityManager em) {
        Image image = new Image().imageURL(DEFAULT_IMAGE_URL);
        return image;
    }
    ...
    public static Image createUpdatedEntity(EntityManager em) {
        Image image = new Image().imageURL(UPDATED_IMAGE_URL);
        return image;
    }
    ...
    void putNewImage() throws Exception {
        ...
        updatedImage.imageURL(UPDATED_IMAGE_URL);
    ...
    void fullUpdateImageWithPatch() throws Exception {
        ...
        partialUpdatedImage.imageURL(UPDATED_IMAGE_URL);
