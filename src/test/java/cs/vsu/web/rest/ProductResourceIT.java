...
class ProductResourceIT {
    ...
    private static final Integer DEFAULT_DISCOUNT_PRICE = 1;
    private static final Integer UPDATED_DISCOUNT_PRICE = 2;
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getViews()).isEqualTo(DEFAULT_VIEWS);
    ...
    void putNewProduct() throws Exception {
        ...
        assertThat(testProduct.getViews()).isEqualTo(UPDATED_VIEWS);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.availability(UPDATED_AVAILABILITY).views(UPDATED_VIEWS);
